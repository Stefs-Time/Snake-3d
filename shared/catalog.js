...
export const GAMES = [
...

  {
    ...
    blurb:
      'Klondike, dealt three at a time. Click a card to lift it — with everything stacked below it, because a run travels as one — then click where it belongs. Double-click sends a card home. Undo as far back as you like.',
    year: 1990,
    genre: 'Cards',
    accent: '#4ade80',
    accent2: '#ff5c7a',
    glyph: 'M6 3h8l4 4v14H6zM10 8h6M10 12h6M10 16h4',
    controls: ['Click a card, then its destination', 'Double-click to send it home', 'U to undo'],
    scoreLabel: 'Score',
